...
(function () {
  ...
  console.log('mode-session.js loaded');
  ...
  console.log('mode-session.js globals set:', {
    captureCurrentModeSession: typeof captureCurrentModeSession,
    restoreModeSession: typeof restoreModeSession,
  });
})();
