...
function wireAppContextSelector() {
  ...
  select.addEventListener('change', () => {
    ...
    if (typeof captureCurrentModeSession === 'function') {
      captureCurrentModeSession('before context switch');
    } else {
      console.warn('captureCurrentModeSession not defined; skipping session capture');
    }
    applyAppContextUi(nextId, 'context switch');
    if (typeof restoreModeSession === 'function') {
      restoreModeSession(nextId, 'after context switch');
    } else {
      console.warn('restoreModeSession not defined; skipping session restore');
    }
  });
